...
def parse_input():
    ...
    parser.add_argument('-d','--path_to_data', type=str, help='path where csv to score is saved')
    parser.add_argument('-m','--path_to_model', type=str, help='path where model binary is saved')
